...
## Périmètre
En __théorie__, les gestionnaires de mots de passe gèrent - comme leur nom l'indique - l'ensemble des mots de passe des comptes Internet (qui vous permettent d'avoir accès aux "espaces personnels" des organisations avec lesquelles vous êtes en contacts") ...   
... mais en __pratique__ ils peuvent gérer de nombreux autres type d'informations, comme par exemples : 
- Les mot de passe et code des ordinateurs et smartphone (PIN, PUK, ICCID, ...)
...
- les autres informations bancaires / monétaires comme les RIB, les "graines crytographiques", ...
